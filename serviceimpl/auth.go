...
func (a *Auth) Verify(c context.Context, req *domains.TokenRequest) (*domains.AuthorizeResponse, error) {
...
func (a *Auth) VerifyToken(req *domains.TokenRequest) (*domains.ValidateResponse, error) {
